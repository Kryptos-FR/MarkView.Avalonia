...
- **Cross-block text selection:** Not supported in v1 (single `SelectableTextBlock` per block). `MarkdownSelectableTextBlock` handles hyperlink hit-testing within a block.
